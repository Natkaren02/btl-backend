...
RULE 4 — PARTIALLY OBSCURED ITEMS. You MUST still include partially visible items. Partial information is better than nothing.
- Describe everything you CAN see
- For the parts you cannot see, add an "obscured_by" field explaining what hides it
- Example: a top where hair covers the neckline should still be included with colour, fit, sleeve style visible, and obscured_by: "neckline hidden by hair"
- NEVER skip an item just because part of it is hidden
...
RULE 6 — TOPS. Always include tops even if partially obscured. Describe:
- The sleeve style if visible (sleeveless, short sleeve, long sleeve)
- The fit if visible (fitted, loose, cropped)
- The colour if visible
- Any visible part of the neckline
- Use obscured_by to note what you cannot see
Example: colour: black, fit: fitted, subcategory: sleeveless top, obscured_by: neckline and shoulder construction hidden by hair
