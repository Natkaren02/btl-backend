...
- Leather: can be shiny (new) OR matte (aged/vintage). Look at the structure — leather holds its shape firmly. Leather grain is smooth even when matte. Edges are clean and finished.
- Suede: always matte, has a visible directional nap or pile texture, surface looks slightly fuzzy. Softer and less structured than leather. 
- Fringe does NOT determine suede vs leather — both materials can have fringe. Look at the body of the bag: structured and firm = leather. Soft and droopy with visible nap = suede.
- When genuinely uncertain between aged leather and suede, note both as a possibility e.g. "leather or aged suede"
